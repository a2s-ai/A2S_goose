...
export const streamSamplingRequests = <ThrowOnError extends boolean = false>(options?: Options<StreamSamplingRequestsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<StreamSamplingRequestsResponses, StreamSamplingRequestsErrors, ThrowOnError>({
        url: '/sampling/stream',
        ...options
    });
};
